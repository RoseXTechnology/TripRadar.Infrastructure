...
resource "azurerm_container_app" "this" {
  ...
  dynamic "secret" {
    for_each = (var.appi_secret_id != null && var.appi_secret_id != "") || ((var.appi_secret_id == null || var.appi_secret_id == "") && var.appi_conn_fallback != null && var.appi_conn_fallback != "" && coalesce(var.appi_conn_fallback, "") != "") ? [1] : []
    content {
      name                = "appi-conn"
